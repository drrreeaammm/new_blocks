...
public static class Modelfirewolf extends EntityModel<Entity> {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.body_rotation.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.body_rotation.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.mane_rotation.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.mane_rotation.rotateAngleX = f4 / (180F / (float) Math.PI);
