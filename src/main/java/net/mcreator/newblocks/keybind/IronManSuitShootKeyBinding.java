...
import net.mcreator.newblocks.procedures.IronManSuitShootOnKeyPressedProcedure;
...
public class IronManSuitShootKeyBinding extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.new_blocks.iron_man_suit_shoot", GLFW.GLFW_KEY_Z, "key.categories.gameplay");
