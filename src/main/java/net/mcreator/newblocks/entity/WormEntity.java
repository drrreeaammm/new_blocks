...
import net.mcreator.newblocks.procedures.WormNaturalEntitySpawningConditionProcedure;
...
public class WormEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("worm_spawn_egg"));
	}
