...
import net.mcreator.newblocks.procedures.FrogOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.procedures.FrogOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.entity.renderer.FrogRenderer;
...
public class FrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("frog").setRegistryName("frog");

	public FrogEntity(NewBlocksModElements instance) {
		super(instance, 857);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8550102, -10129381, new Item.Properties().group(NewblocksItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 11, 4, 4));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			FrogOnInitialEntitySpawnProcedure.executeProcedure(Stream
