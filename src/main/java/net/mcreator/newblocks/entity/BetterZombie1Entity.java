...
import net.mcreator.newblocks.entity.renderer.BetterZombie1Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie1Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_1").setRegistryName("better_zombie_1");
	public BetterZombie1Entity(NewBlocksModElements instance) {
		super(instance, 949);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_1_spawn_egg"));
	}
