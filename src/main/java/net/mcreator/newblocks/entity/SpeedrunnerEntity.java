...
import net.mcreator.newblocks.entity.renderer.SpeedrunnerRenderer;
...
public class SpeedrunnerEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("speedrunner").setRegistryName("speedrunner");

	public SpeedrunnerEntity(NewBlocksModElements instance) {
		super(instance, 1373);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpeedrunnerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14156032, -16777216, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("speedrunner_spawn_egg"));
	}
