...
import net.mcreator.newblocks.entity.renderer.DarkGreenFrogRenderer;
...
public class DarkGreenFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("dark_green_frog").setRegistryName("dark_green_frog");

	public DarkGreenFrogEntity(NewBlocksModElements instance) {
		super(instance, 863);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkGreenFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -11383775, -9147607, new Item.Properties().group(null)).setRegistryName("dark_green_frog_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, SpiderEntity.class, false, false));
