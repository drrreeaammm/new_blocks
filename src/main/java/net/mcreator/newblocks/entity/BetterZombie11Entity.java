...
import net.mcreator.newblocks.entity.renderer.BetterZombie11Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie11Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_11").setRegistryName("better_zombie_11");
	public BetterZombie11Entity(NewBlocksModElements instance) {
		super(instance, 979);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie11Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_11_spawn_egg"));
	}
