...
import net.mcreator.newblocks.procedures.BlazeSpiderOnEntityTickUpdateProcedure;
...
public class BlazeSpiderEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1448150, -1050785, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("blaze_spider_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 12, 4, 4));
	}
