...
import net.mcreator.newblocks.procedures.WardenShouldAttackEntityProcedure;
import net.mcreator.newblocks.itemgroup.DeepDarkTabItemGroup;
import net.mcreator.newblocks.entity.renderer.SculkerRenderer;
import net.mcreator.newblocks.block.SculkVineBlock;
import net.mcreator.newblocks.block.SculkSensorBlock;
import net.mcreator.newblocks.block.SculkCrystalBlock;
import net.mcreator.newblocks.block.SculkBushBlock;
import net.mcreator.newblocks.block.BigSculkVineBlock;
...
public class SculkerEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.7f)).build("sculker").setRegistryName("sculker");
	public SculkerEntity(NewBlocksModElements instance) {
		super(instance, 157);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SculkerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16184303, -9276839, new Item.Properties().group(DeepDarkTabItemGroup.tab))
				.setRegistryName("sculker_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 38);
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 1.6);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(SculkBushBlock.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(SculkCrystalBlock.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(SculkVineBlock.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(SculkSensorBlock.block));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(BigSculkBushBlock.block));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(BigSculkVineBlock.block));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 1.1, 20) {
				@Override
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:sculker_idle"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:sculker_hurt"));
		}
