...
import net.mcreator.newblocks.procedures.SandWormPlayerCollidesWithThisEntityProcedure;
import net.mcreator.newblocks.procedures.SandWormNaturalEntitySpawningConditionProcedure;
...
public class SandWormEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sand_worm_spawn_egg"));
	}
	...
	public static class CustomEntity extends SpiderEntity {
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.sand.hit"));
		}
