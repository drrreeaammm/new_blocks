...
import net.mcreator.newblocks.entity.renderer.TigerFrogRenderer;
...
public class TigerFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("tiger_frog").setRegistryName("tiger_frog");

	public TigerFrogEntity(NewBlocksModElements instance) {
		super(instance, 927);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TigerFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -2392570, -15790579, new Item.Properties().group(null)).setRegistryName("tiger_frog_spawn_egg"));
	}
