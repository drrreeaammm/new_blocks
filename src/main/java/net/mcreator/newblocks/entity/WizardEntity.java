...
import net.mcreator.newblocks.gui.WizardGUIGui;
import net.mcreator.newblocks.entity.renderer.WizardRenderer;
...
public class WizardEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14797907, -14889205, new Item.Properties().group(ItemGroup.MISC))
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Wizard");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new WizardGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
