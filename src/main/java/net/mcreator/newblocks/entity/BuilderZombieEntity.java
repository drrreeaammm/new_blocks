...
import net.mcreator.newblocks.procedures.BuilderZombieOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.procedures.BuilderZombieOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.procedures.BuilderZombieNaturalEntitySpawningConditionProcedure;
...
public class BuilderZombieEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("builder_zombie_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 4, 3, 4));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return BuilderZombieNaturalEntitySpawningConditionProcedure
							.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.12, false));
			this.targetSelector.addGoal(2, new HurtByTargetGoal(this));
			this.goalSelector.addGoal(3, new RandomWalkingGoal(this, 0.83));
			...
			this.goalSelector.addGoal(13, new AvoidEntityGoal(this, IronGolemEntity.class, (float) 6, 1, 1.2));
			this.goalSelector.addGoal(14, new FollowMobGoal(this, (float) 1.33, 34, 18));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			BuilderZombieOnInitialEntitySpawnProcedure.executeProcedure(Stream
