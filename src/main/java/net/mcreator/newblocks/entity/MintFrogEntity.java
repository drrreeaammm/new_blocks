...
import net.mcreator.newblocks.entity.renderer.MintFrogRenderer;
...
public class MintFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("mint_frog").setRegistryName("mint_frog");

	public MintFrogEntity(NewBlocksModElements instance) {
		super(instance, 865);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MintFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -13140109, -14194077, new Item.Properties().group(null)).setRegistryName("mint_frog_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, SpiderEntity.class, false, true));
