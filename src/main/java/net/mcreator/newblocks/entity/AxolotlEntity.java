...
import net.mcreator.newblocks.entity.renderer.AxolotlRenderer;
import net.mcreator.newblocks.NewBlocksModElements;
import net.minecraft.entity.passive.DolphinEntity;

@NewBlocksModElements.ModElement.Tag
public class AxolotlEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.3f, 0.6f)).build("axolotl").setRegistryName("axolotl");
	public AxolotlEntity(NewBlocksModElements instance) {
		super(instance, 766);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -679202, -11001531, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("axolotl_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 17);
