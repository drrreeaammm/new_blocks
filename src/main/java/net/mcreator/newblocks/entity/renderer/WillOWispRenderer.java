...
import net.mcreator.newblocks.entity.WillOWispEntity;
...
public class WillOWispRenderer {
	...
	public static class Modelwill_o_wisp extends EntityModel<Entity> {
		...
		public Modelwill_o_wisp() {
			...
			body.setRotationPoint(1.0F, 27.0F, 0.0F);
			body.setTextureOffset(0, 0).addBox(-1.75F, -4.0F, -1.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		}
