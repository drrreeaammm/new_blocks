...
import net.mcreator.newblocks.entity.PiglinWarriorEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class PiglinWarriorRenderer {
	...
	public static class Modelpiglinwarrior extends EntityModel<Entity> {
		...
		public Modelpiglinwarrior() {
			...
			left_ear.setTextureOffset(51, 6).addBox(10.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
			right_ear = new ModelRenderer(this);
			right_ear.setRotationPoint(5.0F, -6.0F, 0.0F);
			right_ear.setTextureOffset(39, 6).addBox(-11.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
			...
			left_sleeve.setTextureOffset(48, 48).addBox(9.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);
			...
			right_sleeve.setTextureOffset(40, 32).addBox(-13.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);
			...
			right_pants.setTextureOffset(0, 32).addBox(-6.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);
		}
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			...
			this.jacket.rotateAngleX = f4 / (180F / (float) Math.PI);
			this.head.rotateAngleY = f3 / (180F / (float) Math.PI);
			this.head.rotateAngleX = f4 / (180F / (float) Math.PI);
			this.left_sleeve.rotateAngleX = MathHelper.cos(f * 0.6662F) * f1;
			this.headwear.rotateAngleY = f3 / (180F / (float) Math.PI);
			this.headwear.rotateAngleX = f4 / (180F / (float) Math.PI);
			this.right_sleeve.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
