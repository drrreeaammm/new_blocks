...
@OnlyIn(Dist.CLIENT)
public class Rooster2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Rooster2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelrooster(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/rooster_2.png");
					}
				};
			});
		}
