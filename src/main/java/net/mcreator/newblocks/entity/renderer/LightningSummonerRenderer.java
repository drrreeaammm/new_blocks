...
import net.mcreator.newblocks.entity.LightningSummonerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class LightningSummonerRenderer {
	...
	public static class Modellightning_summoner extends EntityModel<Entity> {
		...
		public Modellightning_summoner() {
			...
			hat.setTextureOffset(32, 0).addBox(-4.0F, -34.0F, -4.0F, 8.0F, 10.0F, 8.0F, 0.5F, false);
