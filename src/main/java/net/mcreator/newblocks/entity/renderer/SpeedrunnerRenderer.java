...
import net.mcreator.newblocks.entity.SpeedrunnerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SpeedrunnerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SpeedrunnerEntity.entity, renderManager -> {
	...
	public static class Modeldream extends EntityModel<Entity> {
