...
@OnlyIn(Dist.CLIENT)
public class IceologerRangedRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IceologerRangedEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeliceologer(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/iceologer.png");
					}
				};
			});
		}
	...
	public static class Modeliceologer extends EntityModel<Entity> {
		...
		public Modeliceologer() {
			...
			head.setTextureOffset(70, 33).addBox(-4.5F, -10.5F, -4.5F, 9.0F, 11.0F, 9.0F, 0.0F, false);
			...
			cape.setTextureOffset(99, 16).addBox(-4.5F, 0.0F, 0.0F, 9.0F, 20.0F, 1.0F, 0.0F, false);
