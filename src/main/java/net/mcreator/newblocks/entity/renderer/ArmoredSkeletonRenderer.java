...
import net.mcreator.newblocks.entity.ArmoredSkeletonEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ArmoredSkeletonRenderer {
	...
	public static class Modelarmoredskeleton extends EntityModel<Entity> {
