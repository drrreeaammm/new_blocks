...
import net.mcreator.newblocks.entity.RaccoonEntity;
...
public class RaccoonRenderer {
	...
	public static class Modelraccoon extends EntityModel<Entity> {
		...
		public Modelraccoon() {
			...
			tail_rotation.setRotationPoint(-4.0F, 3.75F, -0.5F);
			tail.addChild(tail_rotation);
			setRotationAngle(tail_rotation, 1.2654F, 0.0F, 0.0F);
			tail_rotation.setTextureOffset(30, 0).addBox(-2.0F, -1.5F, -2.5F, 4.0F, 9.0F, 5.0F, 0.0F, false);
		}
