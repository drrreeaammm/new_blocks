...
@OnlyIn(Dist.CLIENT)
public class Rooster3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Rooster3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelrooster(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/rooster_3.png");
					}
				};
			});
		}
