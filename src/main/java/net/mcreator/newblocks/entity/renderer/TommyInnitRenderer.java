...
import net.mcreator.newblocks.entity.TommyInnitEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TommyInnitRenderer {
	...
	public static class Modeltommyinnit extends EntityModel<Entity> {
		...
		public Modeltommyinnit() {
			...
			left_sleve.setTextureOffset(48, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);
			...
			right_sleve.setTextureOffset(40, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);
