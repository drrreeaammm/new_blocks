...
@OnlyIn(Dist.CLIENT)
public class BlackPoisonFrogRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BlackPoisonFrogEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelfrog(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/black_poison_frog.png");
					}
				};
			});
		}
