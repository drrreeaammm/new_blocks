...
@OnlyIn(Dist.CLIENT)
public class BetterZombie10Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BetterZombie10Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbetter_zombie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/zombie429.png");
					}
				};
			});
		}
