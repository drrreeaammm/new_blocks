...
import net.mcreator.newblocks.entity.KarlJacobsEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class KarlJacobsRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KarlJacobsEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkarl_jacobs(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/karl-jacobs-on-planetminecraft-com.png");
					}
				};
			});
		}
	...
	public static class Modelkarl_jacobs extends EntityModel<Entity> {
		...
		public Modelkarl_jacobs() {
			...
			headwear.setTextureOffset(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.5F, false);
