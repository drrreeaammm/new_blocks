...
import net.mcreator.newblocks.entity.MoobloomEntity;
...
public class MoobloomRenderer {
			...
			RenderingRegistry.registerEntityRenderingHandler(MoobloomEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelmoobloom(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/moobloom.png");
					}
				};
			});
		}
	...
	public static class Modelmoobloom extends EntityModel<Entity> {
		...
		public Modelmoobloom() {
			...
			body_sub_2.setTextureOffset(52, 8).addBox(0.5F, -9.0F, -3.5F, 4.0F, 6.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 8).addBox(1.5F, -9.0F, 5.5F, 4.0F, 6.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 8).addBox(-4.5F, -8.0F, -4.5F, 4.0F, 5.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 8).addBox(-5.5F, -8.0F, 4.5F, 4.0F, 5.0F, 0.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(2.5F, -9.0F, -5.5F, 0.0F, 6.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(3.5F, -9.0F, 3.5F, 0.0F, 6.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(-2.5F, -8.0F, -6.5F, 0.0F, 5.0F, 4.0F, 0.0F, true);
			body_sub_2.setTextureOffset(52, 4).addBox(-3.5F, -8.0F, 2.5F, 0.0F, 5.0F, 4.0F, 0.0F, true);
			...
			leg1.setTextureOffset(0, 16).addBox(6.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
			leg2 = new ModelRenderer(this);
			leg2.setRotationPoint(4.0F, 12.0F, 7.0F);
			leg2.setTextureOffset(0, 16).addBox(-10.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
			leg3 = new ModelRenderer(this);
			leg3.setRotationPoint(-4.0F, 12.0F, -6.0F);
			leg3.setTextureOffset(0, 16).addBox(6.0F, 0.0F, -1.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
			leg4 = new ModelRenderer(this);
			leg4.setRotationPoint(4.0F, 12.0F, -6.0F);
			leg4.setTextureOffset(0, 16).addBox(-10.0F, 0.0F, -1.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
		}
