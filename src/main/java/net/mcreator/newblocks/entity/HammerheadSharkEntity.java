...
import net.mcreator.newblocks.entity.renderer.HammerheadSharkRenderer;
import net.mcreator.newblocks.NewBlocksModElements;
import net.minecraft.entity.passive.DolphinEntity;

@NewBlocksModElements.ModElement.Tag
public class HammerheadSharkEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.9f, 0.6f)).build("hammerhead_shark").setRegistryName("hammerhead_shark");
	public HammerheadSharkEntity(NewBlocksModElements instance) {
		super(instance, 596);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HammerheadSharkRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11709840, -12497558, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("hammerhead_shark_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 6, 1, 3));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 2.1);
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 6);
			ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 1.2000000000000002);
				...
				public void tick() {
					if (this.action == MovementController.Action.MOVE_TO && !CustomEntity.this.getNavigator().noPath()) {
						...
						if (CustomEntity.this.isInWater()) {
							...
							CustomEntity.this.setAIMoveSpeed(f1 * 0.03F);
						}
					} else {
