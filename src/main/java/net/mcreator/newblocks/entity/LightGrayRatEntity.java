...
import net.mcreator.newblocks.procedures.LightGrayRatOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.item.CheeseItem;
import net.mcreator.newblocks.entity.renderer.LightGrayRatRenderer;
...
public class LightGrayRatEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.43f, 0.46f)).build("light_gray_rat").setRegistryName("light_gray_rat");

	public LightGrayRatEntity(NewBlocksModElements instance) {
		super(instance, 1371);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LightGrayRatRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11647675, -11844026, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("light_gray_rat_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1.12, (float) 10, (float) 2, false));
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 0.92));
		...
		public void baseTick() {
			...
			LightGrayRatOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (CheeseItem.block == stack.getItem())
				return true;
			return false;
		}
	}
