...
import net.mcreator.newblocks.procedures.WardenThisEntityKillsAnotherOneProcedure;
import net.mcreator.newblocks.procedures.WardenShouldAttackEntityProcedure;
import net.mcreator.newblocks.procedures.WardenOnInitialEntitySpawnProcedure;
...
import net.mcreator.newblocks.entity.renderer.WardenRenderer;
...
public class WardenEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15705767, -5262213, new Item.Properties().group(DeepDarkTabItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:wardenidle"));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:warden_hurt_2"));
		}
