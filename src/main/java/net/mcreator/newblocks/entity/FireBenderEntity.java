...
import net.mcreator.newblocks.procedures.FireBenderPlayerCollidesWithThisEntityProcedure;
import net.mcreator.newblocks.procedures.FireBenderEntityIsHurtProcedure;
import net.mcreator.newblocks.procedures.FireBenderEntityFallsProcedure;
import net.mcreator.newblocks.procedures.FireBenderEntityDiesProcedure;
...
public class FireBenderEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2293760, -11464174, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("fire_bender_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new AvoidEntityGoal(this, PlayerEntity.class, (float) 3, 0.8, 1));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.illusioner.ambient"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.illusioner.hurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.illusioner.death"));
		}
