...
import net.mcreator.newblocks.procedures.BetterZombieOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.procedures.BetterZombieNaturalEntitySpawningConditionProcedure;
import net.mcreator.newblocks.entity.renderer.BetterZombieRenderer;
...
public class BetterZombieEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie").setRegistryName("better_zombie");
	public BetterZombieEntity(NewBlocksModElements instance) {
		super(instance, 948);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("better_zombie_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("new_blocks:dead_plains").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("new_blocks:dead_plains_hills").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 1, 2, 7));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return BetterZombieNaturalEntitySpawningConditionProcedure.executeProcedure(ImmutableMap.of("world", world));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				BetterZombieOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
