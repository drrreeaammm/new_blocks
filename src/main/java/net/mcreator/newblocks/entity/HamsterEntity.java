...
import net.mcreator.newblocks.item.MarshmallowItem;
import net.mcreator.newblocks.entity.renderer.HamsterRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class HamsterEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("hamster_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(8, new FollowMobGoal(this, (float) 1.4, 5, 5));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (MarshmallowItem.block == stack.getItem())
				return true;
			return false;
		}
	}
