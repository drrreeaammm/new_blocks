...
import net.mcreator.newblocks.procedures.YEsProcedure;
import net.mcreator.newblocks.procedures.NotCowagerProcedure;
import net.mcreator.newblocks.procedures.CowagerOnEntityTickUpdateProcedure;
...
public class CowagerEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(NewblocksItemGroup.tab)).setRegistryName("cowager_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 127);
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1.3, (float) 12, (float) 4, false));
			this.goalSelector.addGoal(4, new OwnerHurtByTargetGoal(this));
			this.goalSelector.addGoal(5, new OwnerHurtTargetGoal(this));
			this.goalSelector.addGoal(6, new BreedGoal(this, 1.4));
			...
			this.goalSelector.addGoal(12, new EatGrassGoal(this));
			this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, PlayerEntity.class, false, false) {
				@Override
			...
			this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, CreatureEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.targetSelector.addGoal(22, new NearestAttackableTargetGoal(this, MobEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.goalSelector.addGoal(25, new BreakDoorGoal(this, e -> true));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.SADDLE));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.ravager.death"));
		}
