...
public class BlackPoisonFrogEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16250615, -1005564, new Item.Properties().group(null))
				.setRegistryName("black_poison_frog_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new AvoidEntityGoal(this, PlayerEntity.class, (float) 3, 1.2, 1.4));
