...
import net.mcreator.newblocks.procedures.TadpoleOnInitialEntitySpawnProcedure;
...
public class TadpoleEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.21f, 0.21f)).build("tadpole").setRegistryName("tadpole");
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 2, 2, 3));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 0.09);
			ammma = ammma.createMutableAttribute(ForgeMod.SWIM_SPEED.get(), 0.34);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			TadpoleOnInitialEntitySpawnProcedure
		...
		public void baseTick() {
			...
			TadpoleOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
