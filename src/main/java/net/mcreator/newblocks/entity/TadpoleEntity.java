...
import net.mcreator.newblocks.procedures.TadpoleOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.entity.renderer.TadpoleRenderer;
...
public class TadpoleEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.2f, 0.3f)).build("tadpole").setRegistryName("tadpole");
	public TadpoleEntity(NewBlocksModElements instance) {
		super(instance, 867);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TadpoleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12041941, -12501712, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("tadpole_spawn_egg"));
	}
	...
	public static class CustomEntity extends CodEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				TadpoleOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
