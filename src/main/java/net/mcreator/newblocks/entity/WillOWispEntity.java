...
import net.mcreator.newblocks.procedures.WillOWispOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.procedures.GetRainProcedure;
...
public class WillOWispEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16007998, -14818840, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("will_o_wisp_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 4, 5, 6));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, AntEntity.CustomEntity.class, false, false));
