...
import net.mcreator.newblocks.entity.renderer.BetterZombie7Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie7Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_7").setRegistryName("better_zombie_7");
	public BetterZombie7Entity(NewBlocksModElements instance) {
		super(instance, 955);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie7Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_7_spawn_egg"));
	}
