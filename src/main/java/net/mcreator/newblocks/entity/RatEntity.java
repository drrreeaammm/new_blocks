...
import net.mcreator.newblocks.entity.renderer.RatRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class RatEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.3f)).build("rat").setRegistryName("rat");

	public RatEntity(NewBlocksModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10725293, -11454457, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("rat_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 4, 1, 4));
	}
