...
import net.mcreator.newblocks.entity.renderer.ChlorineRenderer;
...
public class ChlorineEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.9f, 0.9f)).build("chlorine").setRegistryName("chlorine");
	public ChlorineEntity(NewBlocksModElements instance) {
		super(instance, 643);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChlorineRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("chlorine_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new BreakBlockGoal(Blocks.GRASS_BLOCK, this, 2, (int) 100));
			this.goalSelector.addGoal(6, new BreakBlockGoal(Blocks.DIRT, this, 2, (int) 100));
			this.goalSelector.addGoal(7, new BreakBlockGoal(Blocks.COBBLESTONE, this, 2, (int) 100));
			this.goalSelector.addGoal(8, new BreakBlockGoal(Blocks.OAK_PLANKS, this, 2, (int) 100));
			this.goalSelector.addGoal(9, new BreakBlockGoal(Blocks.SPRUCE_PLANKS, this, 2, (int) 100));
			this.goalSelector.addGoal(10, new BreakBlockGoal(Blocks.BIRCH_PLANKS, this, 2, (int) 100));
			this.goalSelector.addGoal(11, new BreakBlockGoal(Blocks.STONE, this, 2, (int) 100));
			this.goalSelector.addGoal(12, new BreakBlockGoal(Blocks.GRAVEL, this, 2, (int) 100));
			this.goalSelector.addGoal(13, new BreakBlockGoal(Blocks.OAK_LOG, this, 2, (int) 100));
			this.goalSelector.addGoal(14, new BreakBlockGoal(Blocks.TNT, this, 2, (int) 100));
			this.goalSelector.addGoal(15, new OpenDoorGoal(this, true));
			this.goalSelector.addGoal(16, new BreakDoorGoal(this, e -> true));
			this.goalSelector.addGoal(17, new OpenDoorGoal(this, false));
			this.goalSelector.addGoal(18, new LookRandomlyGoal(this));
			this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, PlayerEntity.class, false, false));
			this.targetSelector.addGoal(20, new HurtByTargetGoal(this));
			this.targetSelector.addGoal(21, new SwimLavaGoal(this));
		}
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.nether_ore.step")),
					0.15f, 1);
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.drowned.hurt_water"));
		}
