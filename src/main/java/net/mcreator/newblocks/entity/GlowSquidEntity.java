...
import net.mcreator.newblocks.entity.renderer.GlowSquidRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class GlowSquidEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.7999999999999999f, 0.8f)).build("glow_squid").setRegistryName("glow_squid");

	public GlowSquidEntity(NewBlocksModElements instance) {
		super(instance, 782);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GlowSquidRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14172980, -15440265, new Item.Properties().group(ItemGroup.MISC))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 1, 2, 4));
	}
