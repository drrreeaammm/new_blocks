...
import net.mcreator.newblocks.procedures.ReaperThisEntityKillsAnotherOneProcedure;
import net.mcreator.newblocks.procedures.ReaperEntityIsHurtProcedure;
...
public class ReaperEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(NewblocksItemGroup.tab)).setRegistryName("reaper_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(CharredBoneItem.block));
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:reaper_hurt"));
		}
