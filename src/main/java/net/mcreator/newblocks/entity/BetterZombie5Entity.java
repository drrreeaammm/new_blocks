...
import net.mcreator.newblocks.entity.renderer.BetterZombie5Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie5Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_5").setRegistryName("better_zombie_5");
	public BetterZombie5Entity(NewBlocksModElements instance) {
		super(instance, 953);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie5Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_5_spawn_egg"));
	}
