...
import net.mcreator.newblocks.procedures.TestZombieOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.item.GrenadeItem;
import net.mcreator.newblocks.entity.renderer.TestZombieRenderer;
...
public class TestZombieEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("test_zombie").setRegistryName("test_zombie");
	public TestZombieEntity(NewBlocksModElements instance) {
		super(instance, 1129);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TestZombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null)).setRegistryName("test_zombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				TestZombieOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
