...
import net.mcreator.newblocks.procedures.ArmyDronePlayerCollidesWithThisEntityProcedure;
import net.mcreator.newblocks.procedures.ArmyDroneOnEntityTickUpdateProcedure;
...
public class ArmyDroneEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(NewblocksItemGroup.tab)).setRegistryName("army_drone_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new RandomWalkingGoal(this, 1.6, 20) {
				@Override
			...
			this.goalSelector.addGoal(2, new Goal() {
				...
				public void startExecuting() {
					...
					CustomEntity.this.moveController.setMoveTo(vec3d.x, vec3d.y, vec3d.z, 1.9);
				}
			...
			this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 1.4, false));
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:drone_hurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:drone_death"));
		}
