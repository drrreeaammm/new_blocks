...
public class YellowFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("yellow_frog").setRegistryName("yellow_frog");

	public YellowFrogEntity(NewBlocksModElements instance) {
		super(instance, 861);
		FMLJavaModLoadingContext.get().getModEventBus().register(new YellowFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -4672993, -3555791, new Item.Properties().group(null)).setRegistryName("yellow_frog_spawn_egg"));
	}
