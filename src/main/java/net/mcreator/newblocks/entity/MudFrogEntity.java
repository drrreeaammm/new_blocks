...
import net.mcreator.newblocks.entity.renderer.MudFrogRenderer;
...
public class MudFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("mud_frog").setRegistryName("mud_frog");

	public MudFrogEntity(NewBlocksModElements instance) {
		super(instance, 866);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MudFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -12966643, -14805239, new Item.Properties().group(null)).setRegistryName("mud_frog_spawn_egg"));
	}
