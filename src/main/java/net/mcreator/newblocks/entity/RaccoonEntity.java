...
import net.mcreator.newblocks.entity.renderer.RaccoonRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class RaccoonEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7f, 0.6f)).build("raccoon").setRegistryName("raccoon");
	public RaccoonEntity(NewBlocksModElements instance) {
		super(instance, 207);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RaccoonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11645619, -5395027, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("raccoon_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1.4, (float) 16, (float) 2, false));
