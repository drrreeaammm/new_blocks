...
import net.mcreator.newblocks.entity.renderer.WindcallerRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class WindcallerEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("windcaller_spawn_egg"));
	}
