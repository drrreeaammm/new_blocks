...
import net.mcreator.newblocks.entity.renderer.BetterZombie8Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie8Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_8").setRegistryName("better_zombie_8");
	public BetterZombie8Entity(NewBlocksModElements instance) {
		super(instance, 961);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie8Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_8_spawn_egg"));
	}
