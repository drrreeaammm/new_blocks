...
import net.mcreator.newblocks.procedures.FrogletTickProcedure;
import net.mcreator.newblocks.procedures.FrogletOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.entity.renderer.FrogletRenderer;
...
public class FrogletEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.3099999999999999f, 0.24f)).build("froglet").setRegistryName("froglet");

	public FrogletEntity(NewBlocksModElements instance) {
		super(instance, 1408);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FrogletRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12041941, -12501712, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("froglet_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(ForgeMod.SWIM_SPEED.get(), 0.27);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new RandomSwimmingGoal(this, 4, 40));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			FrogletOnEntityTickUpdateProcedure
		...
		public void baseTick() {
			...
			FrogletTickProcedure.executeProcedure(Stream
