...
import net.mcreator.newblocks.item.LightningVexRangedItem;
import net.mcreator.newblocks.entity.renderer.LightningVexRenderer;
...
public class LightningVexEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.5f)).build("lightning_vex").setRegistryName("lightning_vex");
	public LightningVexEntity(NewBlocksModElements instance) {
		super(instance, 94);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LightningVexRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13689977, -2695548, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("lightning_vex_spawn_egg"));
	}
	...
	public static class CustomEntity extends VexEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			LightningVexRangedItem.shoot(this, target);
		}
