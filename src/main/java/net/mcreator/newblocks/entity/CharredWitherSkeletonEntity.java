...
import net.mcreator.newblocks.procedures.CharredWitherSkeletonPlayerCollidesWithThisEntityProcedure;
import net.mcreator.newblocks.procedures.CharredWitherSkeletonEntityIsHurtProcedure;
import net.mcreator.newblocks.procedures.CharredWitherSkeletonEntityDiesProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.item.CharredBoneItem;
import net.mcreator.newblocks.item.AshSwordItem;
...
public class CharredWitherSkeletonEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("charred_wither_skeleton_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(AshSwordItem.block));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CharredBoneItem.block));
		}
