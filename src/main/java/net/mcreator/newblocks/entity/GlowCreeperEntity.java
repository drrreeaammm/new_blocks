...
import net.mcreator.newblocks.procedures.GlowCreeperPlayerCollidesWithThisEntityProcedure;
...
public class GlowCreeperEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711681, -16156835, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("glow_creeper_spawn_egg"));
	}
