...
import net.mcreator.newblocks.entity.renderer.BetterZombie9Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie9Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_9").setRegistryName("better_zombie_9");
	public BetterZombie9Entity(NewBlocksModElements instance) {
		super(instance, 962);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie9Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_9_spawn_egg"));
	}
