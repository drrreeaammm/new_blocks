...
import net.mcreator.newblocks.entity.renderer.BetterZombie2Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie2Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_2").setRegistryName("better_zombie_2");
	public BetterZombie2Entity(NewBlocksModElements instance) {
		super(instance, 950);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_2_spawn_egg"));
	}
