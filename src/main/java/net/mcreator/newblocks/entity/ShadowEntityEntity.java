...
import net.mcreator.newblocks.entity.renderer.ShadowEntityRenderer;
...
public class ShadowEntityEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("shadow_entity_spawn_egg"));
	}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new Goal() {
				...
				public void startExecuting() {
					...
					CustomEntity.this.moveController.setMoveTo(vec3d.x, vec3d.y, vec3d.z, 2.3);
				}
			...
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 1.6, 20) {
				@Override
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 16; ++l) {
					...
					world.addParticle(ShadowsParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
