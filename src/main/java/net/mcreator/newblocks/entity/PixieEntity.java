...
import net.mcreator.newblocks.entity.renderer.PixieRenderer;
...
public class PixieEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 2.1f)).build("pixie").setRegistryName("pixie");

	public PixieEntity(NewBlocksModElements instance) {
		super(instance, 1444);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("pixie_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, MonsterEntity.class, false, false));
			this.goalSelector.addGoal(4, new WaterAvoidingRandomWalkingGoal(this, 1));
			this.goalSelector.addGoal(5, new AvoidEntityGoal(this, PlayerEntity.class, (float) 12, 1.2, 1.3));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:pixie_"));
		}
