...
import net.mcreator.newblocks.entity.renderer.IcePigRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class IcePigEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -5910802, -8214608, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ice_pig_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 5, 4, 4));
	}
