...
import net.mcreator.newblocks.entity.renderer.EndCrawlerRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class EndCrawlerEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2169180, -5196152, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("end_crawler_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("new_blocks:end_plains").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
