...
import net.mcreator.newblocks.entity.renderer.SnowyFrogRenderer;
...
public class SnowyFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("snowy_frog").setRegistryName("snowy_frog");

	public SnowyFrogEntity(NewBlocksModElements instance) {
		super(instance, 1413);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SnowyFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1976361, -2836810, new Item.Properties().group(null)).setRegistryName("snowy_frog_spawn_egg"));
	}
