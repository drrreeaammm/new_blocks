...
import net.mcreator.newblocks.procedures.RoosterOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.entity.renderer.RoosterRenderer;
...
public class RoosterEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.42f, 0.71f)).build("rooster").setRegistryName("rooster");
	public RoosterEntity(NewBlocksModElements instance) {
		super(instance, 1085);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RoosterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6330085, -11900282, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("rooster_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new FollowMobGoal(this, (float) 1, 16, 8));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				RoosterOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
