...
public class DarkMagicWizardEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dark_magic_wizard_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new AvoidEntityGoal(this, PlayerEntity.class, (float) 24, 1.1, 1.4));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, GolemEntity.class, false, false));
