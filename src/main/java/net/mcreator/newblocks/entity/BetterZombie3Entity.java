...
import net.mcreator.newblocks.entity.renderer.BetterZombie3Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie3Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_3").setRegistryName("better_zombie_3");
	public BetterZombie3Entity(NewBlocksModElements instance) {
		super(instance, 951);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie3Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_3_spawn_egg"));
	}
