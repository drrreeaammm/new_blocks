...
import net.mcreator.newblocks.procedures.VampireGhostPlayerCollidesWithThisEntityProcedure;
import net.mcreator.newblocks.procedures.VampireGhostEntityDiesProcedure;
import net.mcreator.newblocks.item.TotemOfUndyingShardItem;
...
public class VampireGhostEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("vampire_ghost_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new BreakBlockGoal(Blocks.CHEST, this, 1, (int) 15));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TotemOfUndyingShardItem.block));
		}
