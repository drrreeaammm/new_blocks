...
import net.mcreator.newblocks.procedures.IsAirProcedure;
import net.mcreator.newblocks.item.FireballItem;
import net.mcreator.newblocks.entity.renderer.HoveringInfernoRenderer;
...
public class HoveringInfernoEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.7f, 2f)).build("hovering_inferno").setRegistryName("hovering_inferno");
	public HoveringInfernoEntity(NewBlocksModElements instance) {
		super(instance, 796);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HoveringInfernoRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -597974, -14804962, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("hovering_inferno_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 53);
	...
	public static class CustomEntity extends BlazeEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 0.9, 20) {
				@Override
				...
				public boolean shouldExecute() {
					...
					return super.shouldExecute() && IsAirProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				}
				...
				public boolean shouldContinueExecuting() {
					...
					return super.shouldContinueExecuting()
							&& IsAirProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				}
			});
			this.goalSelector.addGoal(3, new Goal() {
				...
				public boolean shouldExecute() {
					if (CustomEntity.this.getAttackTarget() != null && !CustomEntity.this.getMoveHelper().isUpdating()) {
						...
						double z = CustomEntity.this.getPosZ();
						Entity entity = CustomEntity.this;
						return IsAirProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
					} else {
						return false;
					}
				}
				...
				public boolean shouldContinueExecuting() {
					...
					Entity entity = CustomEntity.this;
					return IsAirProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world))
							&& CustomEntity.this.getMoveHelper().isUpdating() && CustomEntity.this.getAttackTarget() != null
			...
			this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 0.9));
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			FireballItem.shoot(this, target);
		}
