...
import net.mcreator.newblocks.procedures.DreamEntityDiesProcedure;
import net.mcreator.newblocks.itemgroup.NewblocksItemGroup;
import net.mcreator.newblocks.entity.renderer.DreamRenderer;
...
public class DreamEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("dream").setRegistryName("dream");
	public DreamEntity(NewBlocksModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14156032, -16777216, new Item.Properties().group(NewblocksItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.DIAMOND_AXE));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				DreamEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
