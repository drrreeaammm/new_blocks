...
import net.mcreator.newblocks.entity.renderer.RangedSoldierRenderer;
...
public class RangedSoldierEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f))
					.build("ranged_soldier").setRegistryName("ranged_soldier");

	public RangedSoldierEntity(NewBlocksModElements instance) {
		super(instance, 1149);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RangedSoldierRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ranged_soldier_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 17;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(RifleItem.block));
		}
