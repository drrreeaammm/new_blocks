...
import net.mcreator.newblocks.entity.renderer.BetterZombie4Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class BetterZombie4Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2f)).build("better_zombie_4").setRegistryName("better_zombie_4");
	public BetterZombie4Entity(NewBlocksModElements instance) {
		super(instance, 952);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BetterZombie4Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13685973, -11718351, new Item.Properties().group(null))
				.setRegistryName("better_zombie_4_spawn_egg"));
	}
