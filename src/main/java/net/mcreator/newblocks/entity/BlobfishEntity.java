...
import net.mcreator.newblocks.entity.renderer.BlobfishRenderer;
import net.mcreator.newblocks.NewBlocksModElements;
import net.minecraft.entity.passive.fish.SalmonEntity;

@NewBlocksModElements.ModElement.Tag
public class BlobfishEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.6f, 0.7000000000000001f)).build("blobfish").setRegistryName("blobfish");
	public BlobfishEntity(NewBlocksModElements instance) {
		super(instance, 601);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlobfishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1345076, -1604411, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("blobfish_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 1, 4, 4));
	}
