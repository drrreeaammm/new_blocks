...
import net.mcreator.newblocks.procedures.DarkMagicWizardCloneOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.procedures.DarkMagicWizardCloneEntityIsHurtProcedure;
import net.mcreator.newblocks.entity.renderer.DarkMagicWizardCloneRenderer;
...
public class DarkMagicWizardCloneEntity extends NewBlocksModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new AvoidEntityGoal(this, PlayerEntity.class, (float) 19, 1, 1.1));
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.evoker.cast_spell"));
		}
