...
import net.mcreator.newblocks.entity.renderer.BrownFrogRenderer;
...
public class BrownFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("brown_frog").setRegistryName("brown_frog");

	public BrownFrogEntity(NewBlocksModElements instance) {
		super(instance, 858);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BrownFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -11652848, -13227759, new Item.Properties().group(null)).setRegistryName("brown_frog_spawn_egg"));
	}
