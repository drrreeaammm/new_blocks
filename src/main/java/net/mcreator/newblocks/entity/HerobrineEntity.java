...
import net.mcreator.newblocks.entity.renderer.HerobrineRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class HerobrineEntity extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16776961, -1, new Item.Properties().group(NewblocksItemGroup.tab))
				.setRegistryName("herobrine_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 133);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(8, new LookAtGoal(this, AgeableEntity.class, (float) 6));
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:herobrinehurt"));
		}
