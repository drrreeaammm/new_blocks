...
import net.mcreator.newblocks.entity.renderer.YellowierFrogRenderer;
...
public class YellowierFrogEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.6f)).build("yellowier_frog").setRegistryName("yellowier_frog");

	public YellowierFrogEntity(NewBlocksModElements instance) {
		super(instance, 862);
		FMLJavaModLoadingContext.get().getModEventBus().register(new YellowierFrogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1714392, -4671719, new Item.Properties().group(null)).setRegistryName("yellowier_frog_spawn_egg"));
	}
