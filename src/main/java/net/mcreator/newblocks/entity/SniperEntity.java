...
import net.mcreator.newblocks.entity.renderer.SniperRenderer;
...
public class SniperEntity extends NewBlocksModElements.ModElement {
	...
	public SniperEntity(NewBlocksModElements instance) {
		super(instance, 1125);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SniperRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sniper_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 26;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(SniperRifileItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(SniperBulletItem.block));
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			SniperRifileItem.shoot(this, target);
		}
	}
}
