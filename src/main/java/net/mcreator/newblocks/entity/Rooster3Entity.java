...
import net.mcreator.newblocks.entity.renderer.Rooster3Renderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class Rooster3Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.42f, 0.71f)).build("rooster_3").setRegistryName("rooster_3");

	public Rooster3Entity(NewBlocksModElements instance) {
		super(instance, 1089);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Rooster3Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("rooster_3_spawn_egg"));
	}
