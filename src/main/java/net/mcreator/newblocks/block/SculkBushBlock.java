...
import net.mcreator.newblocks.procedures.SculkBushPlantAddedProcedure;
...
public class SculkBushBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sculk_bush")
	public static final Block block = null;
	public SculkBushBlock(NewBlocksModElements instance) {
		super(instance, 162);
			...
			configuredFeature = feature
					.withConfiguration(
							(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(block.getDefaultState()), new SimpleBlockPlacer()))
									.tries(16).build())
					.withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).func_242731_b(24);
			event.getRegistry().register(feature.setRegistryName("sculk_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:sculk_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
		...
		public BlockCustomFlower() {
			super(Effects.SLOWNESS, 8,
					Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT)
							...
							.setLightLevel(s -> 3));
			setRegistryName("sculk_bush");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(3, 0, 3, 10, 7, 10)).withOffset(offset.x, offset.y, offset.z);
		}
