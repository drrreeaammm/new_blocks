...
public class MossBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:moss")
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!MossAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
