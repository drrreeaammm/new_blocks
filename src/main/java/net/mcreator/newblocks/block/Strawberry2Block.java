...
import net.mcreator.newblocks.procedures.Strawberry2UpdateTickProcedure;
...
public class Strawberry2Block extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:strawberry_2")
	public static final Block block = null;
	public Strawberry2Block(NewBlocksModElements instance) {
		super(instance, 1252);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("strawberry_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:strawberry_2"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("strawberry_2");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 2.8, 16)).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StrawberrySeedsBlock.block));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Strawberry2UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
