...
public class AzaleaBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:azalea")
	public static final Block block = null;

	public AzaleaBlock(NewBlocksModElements instance) {
		super(instance, 1451);
	}
