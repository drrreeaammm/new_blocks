...
import net.mcreator.newblocks.procedures.FloweringAzaleaLeavesBlockDestroyedByPlayerProcedure;
...
public class FloweringAzaleaLeavesBlock extends NewBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.VINE).hardnessAndResistance(0.3f, 0.5f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("flowering_azalea_leaves");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:flowering_azalea_leaves_match"),
			...
			event.getRegistry().register(feature.setRegistryName("flowering_azalea_leaves"));
