...
import net.mcreator.newblocks.procedures.WetMudUpdateTickProcedure;
import net.mcreator.newblocks.procedures.WetMudMobplayerCollidesBlockProcedure;
...
public class WetMudBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:wet_mud")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("new_blocks:wet_mud_bucket")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("wet_mud_lakes"));
