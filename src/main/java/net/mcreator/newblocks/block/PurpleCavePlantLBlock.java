...
import net.mcreator.newblocks.procedures.PurpleSmallClickedProcedure;
...
public class PurpleCavePlantLBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:purple_cave_plant_l")
	public static final Block block = null;

	public PurpleCavePlantLBlock(NewBlocksModElements instance) {
		super(instance, 1496);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_cave_plant_l");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			PurpleSmallClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
