...
public class MangroveWoodBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:mangrove_wood")
	public static final Block block = null;
	public MangroveWoodBlock(NewBlocksModElements instance) {
		super(instance, 897);
	}
