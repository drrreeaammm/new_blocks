...
public class SculkSensorActiveBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sculk_sensor_active")
	public static final Block block = null;

	public SculkSensorActiveBlock(NewBlocksModElements instance) {
		super(instance, 1010);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.MISCELLANEOUS)
					...
					.hardnessAndResistance(1.3f, 1.5f).setLightLevel(s -> 5).notSolid().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("sculk_sensor_active");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SculkSensorBlock.block));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(pos, this, 47);
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:sculk_sensor_active_match"),
			...
			event.getRegistry().register(feature.setRegistryName("sculk_sensor_active"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:sculk_sensor_active"), configuredFeature);
		}
	}
