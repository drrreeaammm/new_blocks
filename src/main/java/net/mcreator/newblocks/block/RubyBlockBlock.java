...
public class RubyBlockBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:ruby_block")
	public static final Block block = null;

	public RubyBlockBlock(NewBlocksModElements instance) {
		super(instance, 66);
	}
