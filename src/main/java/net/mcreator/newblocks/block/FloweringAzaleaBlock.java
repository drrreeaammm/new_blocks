...
import net.mcreator.newblocks.procedures.FloweringAzaleaOnBlockRightClickedProcedure;
import net.mcreator.newblocks.procedures.AzaleaAdditionalGenerationConditionProcedure;
...
public class FloweringAzaleaBlock extends NewBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("flowering_azalea");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			FloweringAzaleaOnBlockRightClickedProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:flowering_azalea_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 1)).range(52)
					.square().func_242731_b(30);
			event.getRegistry().register(feature.setRegistryName("flowering_azalea"));
