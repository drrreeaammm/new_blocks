...
import net.mcreator.newblocks.procedures.FlamebladeProcedureTakeProcedure;
...
public class SwordStandFlamebladeBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sword_stand_flameblade")
	public static final Block block = null;
	public SwordStandFlamebladeBlock(NewBlocksModElements instance) {
		super(instance, 1092);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sword_stand_flameblade");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FlamebladeItem.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				FlamebladeProcedureTakeProcedure.executeProcedure($_dependencies);
			}
