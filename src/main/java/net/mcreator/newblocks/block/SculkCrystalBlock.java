...
public class SculkCrystalBlock extends NewBlocksModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sculk_crystal"));
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.MINING_FATIGUE, 17,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.STONE).hardnessAndResistance(1.2f, 0.5f)
							.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setLightLevel(s -> 9));
			setRegistryName("sculk_crystal");
		}
