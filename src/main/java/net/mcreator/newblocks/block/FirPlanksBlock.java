...
public class FirPlanksBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fir_planks")
	public static final Block block = null;
	public FirPlanksBlock(NewBlocksModElements instance) {
		super(instance, 112);
	}
