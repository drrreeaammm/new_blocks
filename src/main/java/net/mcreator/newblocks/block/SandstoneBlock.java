...
public class SandstoneBlock extends NewBlocksModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:sandstone_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 44)).range(64)
					.square().func_242731_b(40);
			event.getRegistry().register(feature.setRegistryName("sandstone"));
