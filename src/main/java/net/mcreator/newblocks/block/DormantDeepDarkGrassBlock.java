...
import net.mcreator.newblocks.procedures.DormantDeepDarkGrassEntityWalksOnTheBlockProcedure;
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.6000000000000001f, 10f)
					.setLightLevel(s -> 0).setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("dormant_deep_dark_grass");
		}
