...
import net.mcreator.newblocks.procedures.Lettuce1UpdateTickProcedure;
...
public class Lettuce1Block extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:lettuce_1")
	public static final Block block = null;
	public Lettuce1Block(NewBlocksModElements instance) {
		super(instance, 1226);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lettuce_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:lettuce_1"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("lettuce_1");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 2.1, 16)).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LettuceSeedsBlock.block));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Lettuce1UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
