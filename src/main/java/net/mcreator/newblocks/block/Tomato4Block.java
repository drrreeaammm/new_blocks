...
import net.mcreator.newblocks.procedures.Tomato4UpdateTickProcedure;
...
public class Tomato4Block extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:tomato_4")
	public static final Block block = null;
	public Tomato4Block(NewBlocksModElements instance) {
		super(instance, 1209);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Tomato4UpdateTickProcedure.executeProcedure($_dependencies);
			}
