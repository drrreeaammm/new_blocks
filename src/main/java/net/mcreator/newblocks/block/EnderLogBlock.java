...
public class EnderLogBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:ender_log")
	public static final Block block = null;

	public EnderLogBlock(NewBlocksModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 4.5f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("ender_log");
		}
