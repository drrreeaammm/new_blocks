...
import net.mcreator.newblocks.procedures.SculkPlantTrapMobplayerCollidesWithPlantProcedure;
...
public class SculkPlantTrapBlock extends NewBlocksModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sculk_plant_trap"));
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sculk_plant_trap");
		}
