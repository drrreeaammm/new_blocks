...
public class SkulkBlockBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:skulk_block")
	public static final Block block = null;

	public SkulkBlockBlock(NewBlocksModElements instance) {
		super(instance, 129);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(1.15f, 5f).setLightLevel(s -> 0));
			setRegistryName("skulk_block");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:skulk_block_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 10)).range(43)
					.square().func_242731_b(16);
			event.getRegistry().register(feature.setRegistryName("skulk_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:skulk_block"), configuredFeature);
		}
	}
