...
public class FirWoodBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fir_wood")
	public static final Block block = null;

	public FirWoodBlock(NewBlocksModElements instance) {
		super(instance, 110);
	}
