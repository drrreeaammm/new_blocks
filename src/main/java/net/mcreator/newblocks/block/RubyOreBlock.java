...
import net.mcreator.newblocks.item.RubyItem;
...
public class RubyOreBlock extends NewBlocksModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:ruby_ore_match"), () -> CustomRuleTest.codec);
