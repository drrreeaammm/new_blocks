...
public class GrimstoneBrickWallBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:grimstone_brick_wall")
	public static final Block block = null;

	public GrimstoneBrickWallBlock(NewBlocksModElements instance) {
		super(instance, 810);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3.9000000000000004f, 15f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("grimstone_brick_wall");
		}
