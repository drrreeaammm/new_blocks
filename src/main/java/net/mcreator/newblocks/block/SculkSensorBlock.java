...
import net.mcreator.newblocks.procedures.SculkSensorOnUpdateTickProcedure;
import net.mcreator.newblocks.procedures.SculkSensorEntityWalksOnTheBlockProcedure;
...
public class SculkSensorBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sculk_sensor")
	public static final Block block = null;

	public SculkSensorBlock(NewBlocksModElements instance) {
		super(instance, 165);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.MISCELLANEOUS)
					...
					.hardnessAndResistance(1.3f, 1.5f).setLightLevel(s -> 1).notSolid().setOpaque((bs, br, bp) -> false));
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SculkSensorOnUpdateTickProcedure.executeProcedure(Stream
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			SculkSensorEntityWalksOnTheBlockProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:sculk_sensor_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("sculk_sensor"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:sculk_sensor"), configuredFeature);
		}
	}
