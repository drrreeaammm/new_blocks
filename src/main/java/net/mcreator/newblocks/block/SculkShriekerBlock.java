...
import net.mcreator.newblocks.procedures.SculkShriekerBlockDestroyedByPlayerProcedure;
...
public class SculkShriekerBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sculk_shrieker")
	public static final Block block = null;

	public SculkShriekerBlock(NewBlocksModElements instance) {
		super(instance, 802);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(1.7f, 7.5f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool()
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			SculkShriekerBlockDestroyedByPlayerProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:sculk_shrieker_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("sculk_shrieker"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:sculk_shrieker"), configuredFeature);
		}
	}
