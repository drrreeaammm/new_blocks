...
import net.mcreator.newblocks.procedures.SummonRootProcedure;
...
public class SummonTheRootsBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:summon_the_roots")
	public static final Block block = null;

	public SummonTheRootsBlock(NewBlocksModElements instance) {
		super(instance, 1481);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("summon_the_roots");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			SummonRootProcedure.executeProcedure(Stream
