...
public class MangroveLogBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:mangrove_log")
	public static final Block block = null;

	public MangroveLogBlock(NewBlocksModElements instance) {
		super(instance, 896);
	}
