...
import net.mcreator.newblocks.procedures.RedClickedLeftProcedure;
...
public class RedCavePlantMiddleBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:red_cave_plant_middle")
	public static final Block block = null;

	public RedCavePlantMiddleBlock(NewBlocksModElements instance) {
		super(instance, 1502);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_cave_plant_middle");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			RedClickedLeftProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
