...
public class FreshWaterBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fresh_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("new_blocks:fresh_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public FreshWaterBlock(NewBlocksModElements instance) {
		super(instance, 887);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("new_blocks:blocks/fresh_water_still"), new ResourceLocation("new_blocks:blocks/fresh_water_flow"))
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("fresh_water");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("fresh_water_flowing");
		elements.blocks
