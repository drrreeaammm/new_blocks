...
import net.mcreator.newblocks.procedures.DeepDarkGenProcedure;
...
public class DeepDarkBigCaveGenBlock extends NewBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_dark_big_cave_gen");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:deep_dark_big_cave_gen_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 20)).range(39)
					.square().func_242731_b(12);
			event.getRegistry().register(feature.setRegistryName("deep_dark_big_cave_gen"));
