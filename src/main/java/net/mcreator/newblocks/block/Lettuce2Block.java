...
import net.mcreator.newblocks.procedures.Lettuce2UpdateTickProcedure;
...
public class Lettuce2Block extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:lettuce_2")
	public static final Block block = null;
	public Lettuce2Block(NewBlocksModElements instance) {
		super(instance, 1227);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Lettuce2UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
