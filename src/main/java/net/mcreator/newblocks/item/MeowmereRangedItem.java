...
import net.mcreator.newblocks.procedures.MeowmereRangedWhileBulletFlyingTickProcedure;
import net.mcreator.newblocks.procedures.MeowmereRangedBulletHitsLivingEntityProcedure;
import net.mcreator.newblocks.procedures.MeowmereRangedBulletHitsBlockProcedure;
...
public class MeowmereRangedItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:meowmere_ranged")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("meowmere_ranged");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 3.5, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CatItem.block);
		}
