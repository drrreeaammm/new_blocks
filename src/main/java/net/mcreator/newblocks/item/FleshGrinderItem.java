...
public class FleshGrinderItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:flesh_grinder")
	public static final Item block = null;
	public FleshGrinderItem(NewBlocksModElements instance) {
		super(instance, 1314);
	}
