...
import net.mcreator.newblocks.procedures.FireballBulletHitsLivingEntityProcedure;
import net.mcreator.newblocks.procedures.FireballBulletHitsBlockProcedure;
...
public class FireballItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fireball")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.0999999999999999f, 2.4, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FireballItem.block);
		}
