...
import net.mcreator.newblocks.entity.renderer.SpearRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

import java.util.Random;

@NewBlocksModElements.ModElement.Tag
public class SpearItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:spear")
	...
	public SpearItem(NewBlocksModElements instance) {
		super(instance, 89);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpearRenderer.ModelRegisterHandler());
	}
