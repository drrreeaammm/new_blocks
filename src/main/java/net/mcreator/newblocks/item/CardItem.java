...
import net.mcreator.newblocks.entity.renderer.CardRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

import java.util.Random;

@NewBlocksModElements.ModElement.Tag
public class CardItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:card")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.88f, 1.2999999999999998, 0);
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.shoot(d1, d0 - entityarrow.getPosY() + (double) MathHelper.sqrt(d1 * d1 + d3 * d3) * 0.2F, d3, 0.88f * 2, 12.0F);
		entityarrow.setSilent(true);
		entityarrow.setDamage(1.2999999999999998);
