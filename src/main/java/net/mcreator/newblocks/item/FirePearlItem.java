...
import net.mcreator.newblocks.procedures.FirePearlWhileBulletFlyingTickProcedure;
import net.mcreator.newblocks.procedures.FirePearlRangedItemUsedProcedure;
import net.mcreator.newblocks.procedures.FirePearlBulletHitsLivingEntityProcedure;
import net.mcreator.newblocks.procedures.FirePearlBulletHitsBlockProcedure;
...
public class FirePearlItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fire_pearl")
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Faster. Farther. Flamier?..."));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FLAMEPEARLITEMTEXTUReItem.block);
		}
