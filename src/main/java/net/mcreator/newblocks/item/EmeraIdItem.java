...
public class EmeraIdItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:emera_id_helmet")
	public static final Item helmet = null;
	@ObjectHolder("new_blocks:emera_id_chestplate")
	public static final Item body = null;
	@ObjectHolder("new_blocks:emera_id_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "new_blocks:textures/models/armor/emerald__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
