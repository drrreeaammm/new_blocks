...
import net.mcreator.newblocks.procedures.CascadeSwordLivingEntityIsHitWithToolProcedure;
...
public class CascadeSwordItem extends NewBlocksModElements.ModElement {
	...
	public void initElements() {
		...
		}, 3, -2.2f, new Item.Properties().group(NewblocksItemGroup.tab).isImmuneToFire()) {
			@Override
