...
public class GlowBerriesItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:glow_berries")
	public static final Item block = null;

	public GlowBerriesItem(NewBlocksModElements instance) {
		super(instance, 1466);
	}
