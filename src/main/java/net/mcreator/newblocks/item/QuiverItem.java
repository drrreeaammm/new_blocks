...
import net.mcreator.newblocks.gui.QuiverGUIGuiWindow;
import net.mcreator.newblocks.gui.QuiverGUIGui;
...
public class QuiverItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:quiver")
	public static final Item block = null;

	public QuiverItem(NewBlocksModElements instance) {
		super(instance, 88);
