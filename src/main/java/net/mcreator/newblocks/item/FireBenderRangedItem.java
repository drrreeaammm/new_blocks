...
import net.mcreator.newblocks.entity.renderer.FireBenderRangedRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

import java.util.Random;

@NewBlocksModElements.ModElement.Tag
public class FireBenderRangedItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:fire_bender_ranged")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("fire_bender_ranged");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 2.1, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FireBenderRangedItem.block);
		}
