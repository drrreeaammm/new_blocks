...
import net.mcreator.newblocks.procedures.FlamebladeRightClickedInAirProcedure;
import net.mcreator.newblocks.procedures.FlamebladeLivingEntityIsHitWithToolProcedure;
import net.mcreator.newblocks.procedures.FlamebladeItemInHandTickProcedure;
