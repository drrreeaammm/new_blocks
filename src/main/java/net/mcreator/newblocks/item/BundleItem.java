...
import net.mcreator.newblocks.gui.BundleGUIGuiWindow;
import net.mcreator.newblocks.gui.BundleGUIGui;
...
public class BundleItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:bundle")
	public static final Item block = null;

	public BundleItem(NewBlocksModElements instance) {
		super(instance, 81);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BundleGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Bundle");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BundleGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
