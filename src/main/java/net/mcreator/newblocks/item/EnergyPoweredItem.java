...
import net.mcreator.newblocks.procedures.EnergyPoweredBodyTickEventProcedure;
...
public class EnergyPoweredItem extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:energy_powered_helmet")
	public static final Item helmet = null;
	@ObjectHolder("new_blocks:energy_powered_chestplate")
	public static final Item body = null;
	@ObjectHolder("new_blocks:energy_powered_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(NewblocksItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "new_blocks:textures/models/armor/energy_powered_chestplate__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
