...
public class ToolBeltGUIGui extends NewBlocksModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public ToolBeltGUIGui(NewBlocksModElements instance) {
		super(instance, 386);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("tool_belt_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, ToolBeltGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 50, 26) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 71, 26) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 92, 26) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 113, 26) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 134, 26) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 155, 26) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
