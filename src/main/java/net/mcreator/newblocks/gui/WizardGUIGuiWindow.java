...
@OnlyIn(Dist.CLIENT)
public class WizardGUIGuiWindow extends ContainerScreen<WizardGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "=", 82, 21, -12829636);
		this.font.drawString(ms, "5", 73, 4, -12829636);
		this.font.drawString(ms, "1", 116, 4, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 63, this.guiTop + 56, 50, 20, new StringTextComponent("Trade"), e -> {
			if (true) {
				NewBlocksMod.PACKET_HANDLER.sendToServer(new WizardGUIGui.ButtonPressedMessage(0, x, y, z));
				WizardGUIGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
