	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency y for procedure DeepDarkHallwayOnStructureInstanceGenerated!");
			return;
		}
		...
		if (Math.random() < 0.9) {
			if (world instanceof ServerWorld) {
				...
				if (template != null) {
					template.func_237144_a_((ServerWorld) world, new BlockPos((int) (x + 16), (int) y, (int) z),
