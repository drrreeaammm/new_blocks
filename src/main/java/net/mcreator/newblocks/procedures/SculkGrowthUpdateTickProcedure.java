...
public class SculkGrowthUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		for (int index0 = 0; index0 < (int) (6); index0++) {
			...
			for (int index1 = 0; index1 < (int) (3); index1++) {
				...
				for (int index2 = 0; index2 < (int) (6); index2++) {
					if (((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz)))).getBlock() == GrimstoneBlock.block)) {
						found = (boolean) (true);
					}
					sz = (double) (sz + 1);
				}
		...
		if ((found == (true))) {
			world.setBlockState(new BlockPos((int) sx, (int) sy, (int) sz), SkulkBlockBlock.block.getDefaultState(), 3);
			world.setBlockState(new BlockPos((int) sx, (int) (sy + 1), (int) sz), SculkGrowthBlock.block.getDefaultState(), 3);
		}
	}
}
