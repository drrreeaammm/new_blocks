...
import net.mcreator.newblocks.item.SilverMedkitItem;
import net.mcreator.newblocks.NewBlocksMod;

import java.util.Map;
import java.util.Iterator;

public class SilverMedkitClickedProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency entity for procedure SilverMedkitClicked!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency itemstack for procedure SilverMedkitClicked!");
			return;
		}
		...
		if (entity instanceof LivingEntity)
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.REGENERATION, (int) 125, (int) 1, (false), (true)));
		entity.getPersistentData().putDouble("BandageUsed", (entity.getPersistentData().getDouble("BandageUsed") + 1));
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(SilverMedkitItem.block);
