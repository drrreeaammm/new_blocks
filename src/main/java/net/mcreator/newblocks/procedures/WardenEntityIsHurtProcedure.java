	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency x for procedure WardenEntityIsHurt!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency y for procedure WardenEntityIsHurt!");
			return;
		}
		...
		}
		{
			...
			if (!_ent.world.isRemote && _ent.world.getServer() != null) {
				_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
						"attribute @e[type=new_blocks:warden] minecraft:generic.follow_range base set 35");
			}
		}
		new Object() {
			private int ticks = 0;
			...
			private void run() {
				{
					...
					if (!_ent.world.isRemote && _ent.world.getServer() != null) {
						_ent.world.getServer().getCommandManager().handleCommand(
								...
								"attribute @e[type=new_blocks:warden] minecraft:generic.follow_range base set 6");
					}
				}
			...
			private void run() {
				{
					...
					if (!_ent.world.isRemote && _ent.world.getServer() != null) {
						_ent.world.getServer().getCommandManager().handleCommand(
								_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), "particle new_blocks:vibration ~ ~2.5 ~");
					}
				}
				MinecraftForge.EVENT_BUS.unregister(this);
			}
