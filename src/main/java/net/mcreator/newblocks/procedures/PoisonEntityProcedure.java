...
public class PoisonEntityProcedure {
		...
		if (sourceentity instanceof BlackPoisonFrogEntity.CustomEntity) {
			...
			if ((new Random()).nextInt((int) 3 + 1) == 0) {
				new Object() {
					...
					private void run() {
						if (entity instanceof LivingEntity)
							((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.POISON, (int) 60, (int) 2, (false), (true)));
				...
				new Object() {
					...
					private void run() {
						if (entity instanceof LivingEntity)
							((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.POISON, (int) 40, (int) 3, (false), (true)));
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				}.start(world, (int) 650);
				...
				new Object() {
					...
					private void run() {
						if (entity instanceof LivingEntity)
							((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.POISON, (int) 100, (int) 2, (false), (true)));
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				...
				new Object() {
					...
					private void run() {
						if (entity instanceof LivingEntity)
							((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.POISON, (int) 35, (int) 4, (false), (true)));
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				}.start(world, (int) 450);
			}
