...
import net.mcreator.newblocks.item.GoldMedkitItem;
import net.mcreator.newblocks.NewBlocksMod;

import java.util.Map;
import java.util.Iterator;

public class GoldMedkitClickedProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency entity for procedure GoldMedkitClicked!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency itemstack for procedure GoldMedkitClicked!");
			return;
		}
		...
		if (entity instanceof LivingEntity)
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.REGENERATION, (int) 145, (int) 2, (false), (true)));
		entity.getPersistentData().putDouble("BandageUsed", (entity.getPersistentData().getDouble("BandageUsed") + 1));
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(GoldMedkitItem.block);
