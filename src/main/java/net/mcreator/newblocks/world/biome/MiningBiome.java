...
public class MiningBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;

	public MiningBiome(NewBlocksModElements instance) {
		super(instance, 1356);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-15501898).setWaterFogColor(-15501898)
						.withSkyColor(7972607).withFoliageColor(-15485403).withGrassColor(-15485403).build();
				...
				event.getRegistry().register(biome.setRegistryName("new_blocks:mining"));
			}
		}
	}
