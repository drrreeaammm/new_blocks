...
public class BigSculkCavernsBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;
	public BigSculkCavernsBiome(NewBlocksModElements instance) {
		super(instance, 989);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("new_blocks:big_sculk_caverns"));
			}
		}
	}
	@Override
