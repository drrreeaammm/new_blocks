...
public class SculkVineCavesBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;
	public SculkVineCavesBiome(NewBlocksModElements instance) {
		super(instance, 712);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("new_blocks:sculk_vine_caves"));
			}
		}
	}
	@Override
