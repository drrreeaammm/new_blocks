...
public class EndHillsBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;
	public EndHillsBiome(NewBlocksModElements instance) {
		super(instance, 673);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-11400103).setWaterColor(-11004767).setWaterFogColor(-12514693)
						.withSkyColor(-11400103).withFoliageColor(-7072607).withGrassColor(-7268708)
				...
				event.getRegistry().register(biome.setRegistryName("new_blocks:end_hills"));
			}
		}
	}
	@Override
