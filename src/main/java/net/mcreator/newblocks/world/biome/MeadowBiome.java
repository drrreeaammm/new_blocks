...
public class MeadowBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;
	public MeadowBiome(NewBlocksModElements instance) {
		super(instance, 875);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-15839537).setWaterFogColor(-15839537)
						.withSkyColor(7972607).withFoliageColor(-10245816).withGrassColor(-8144019).build();
				...
				event.getRegistry().register(biome.setRegistryName("new_blocks:meadow"));
			}
		}
	}
	@Override
